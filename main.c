...
Sensor_Data_Type Sensor_Data[5] = {
    {'T', 0.0, "000.00\0"},{'L', 0.0, "000.00\0"},{'S', 0.0, "000.00\0"},{'H', 0.0, "000.00\0"}, {'D', 0.0, "000.00\0"}
};
...
int main(void) {
    ...
    for (;;) {
        ...
        DHT11_Read(&Sensor_Data[DHT11_H].ADC_Sensor_Value, &Sensor_Data[DHT11_T].ADC_Sensor_Value);
        
        Float_To_String(Sensor_Data[DHT11_H].ADC_Sensor_Value, Sensor_Data[DHT11_H].String_Sensor_Value);
              
        UART_printString(&Sensor_Data[DHT11_H].String_Sensor_Value[0]);
        
        Float_To_String(Sensor_Data[DHT11_T].ADC_Sensor_Value, Sensor_Data[DHT11_T].String_Sensor_Value);
              
        UART_printString(&Sensor_Data[DHT11_T].String_Sensor_Value[0]);
